		...
		<!-- //////////////////////////////////////////// -->
				...
				<div class="table__header">
					<div class="table__row">
						<div class="row__data">
							<div class="row__celd"><span class="celd__header">User</span></div>
							<div class="row__celd"><span class="celd__header">Language</span></div>
						</div>
					</div>
				</div>
					...
					<c:forEach var="user" items="${users}">
						<div class="table__row">
							<div class="row__data">
								...
								<div class="row__celd">
									<span> <c:out value="${user.getLanguage().getName()}" /> </span>
								</div>
							</div>
				...
				<form class="table__footer" action="/users" method="POST">
				
					<div class="table__row">
						<div class="row__data">
								<div class="row__celd">
									<select name="language" class="celd__select">
